<template>
  <div>
    ...
    <el-dialog title="分配权限" :visible.sync="setRightDialogVisible" width="50%" @close="setRightDialogClosed">
        <!--树形控件-->
      <el-tree :data="rightslist" ref="treeRef" :props="treeProps" show-checkbox node-key="id" :default-checked-keys="defKeys" default-expand-all></el-tree>
...
export default {
    ...
    return {
      ...
      editFormRules: {
        ...
        roleDesc: [
          ...
          { min: 1, max: 15, message: '角色描述的长度在1-15个字符之间', trigger: 'blur' }
        ]
      },
  ...
  methods: {
    ...
    // 通过递归形式，获取角色下所有三级权限的id并保存到 defKeys 数组中
